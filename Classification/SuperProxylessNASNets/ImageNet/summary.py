...
from models.SuperProxylessNAS.super_proxyless_masked import SuperProxylessNASNets_Masked
...
if __name__ == '__main__':
	...
	#model = SuperProxylessNASNets_Masked()
	model = SuperProxylessNASNets_AutoML()
	print("model:", model)
