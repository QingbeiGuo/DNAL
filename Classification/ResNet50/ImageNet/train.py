...
import math
#model
from models.resnet.resnet_AutoML import ResNet_AutoML, resnet50_AutoML
...
def get_args():
    ...
    parser.add_argument('--arch', '--a', default='ResNet50', help='model architecture: (default: ResNet50)')
